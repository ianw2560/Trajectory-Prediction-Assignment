...
plot_min_ade_all("ade_mean", csv_path="metrics.csv", out_path="images/ade_mean_summary.png")
plot_min_ade_all("fde_mean", csv_path="metrics.csv", out_path="images/fde_mean_summary.png")